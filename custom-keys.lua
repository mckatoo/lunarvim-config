...
lvim.keys.normal_mode["<M-;>"] = ":lua Toggle_semicolon()<CR>"
lvim.keys.normal_mode["<M-,>"] = ":lua Toggle_comma()<CR>"
lvim.keys.normal_mode["<C-a>"] = ":wall<CR>"
lvim.keys.normal_mode["<C-o>"] = ':%bdelete|edit #|normal`"<CR>'
lvim.keys.normal_mode["<leader>so"] = ":OrganizeImports<CR>"
...
lvim.keys.insert_mode["<M-;>"] = "<ESC>:lua Toggle_semicolon()<CR>i<Right>"
lvim.keys.insert_mode["<M-,>"] = "<ESC>:lua Toggle_comma()<CR>i<Right>"
